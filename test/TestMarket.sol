...
//The expected owner of sold pet is this contract
 address expectedBuyer = address(this);

// Testing the buy() function
function testUserCanBuyPet() public {
  uint returnedId = market.buy(expectedPetId);

  Assert.equal(returnedId, expectedPetId, "Market of the expected pet should match what is returned.");
}

// Testing retrieval of a single pet's owner
function testGetBuyerAddressByPetId() public {
  address buyer = market.buyers(expectedPetId);
